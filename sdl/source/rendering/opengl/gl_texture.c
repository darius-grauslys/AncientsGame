...
PLATFORM_Texture *GL_allocate_texture_with__path(
    ...
    if (width != p_PLATFORM_texture->width) {
        debug_warning("SDL::GL::PLATFORM_allocate_texture__with__path, invalid width.");
    }

    if (height != p_PLATFORM_texture->height) {
        debug_warning("SDL::GL::PLATFORM_allocate_texture__with__path, invalid height.");
    }

    if (channels != requested_channels) {
        debug_warning("SDL::GL::PLATFORM_allocate_texture__with__path, invalid channels.");
    }
