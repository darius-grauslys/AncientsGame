...
void inline set_shader_mat4_model__scale(
        GL_Shader_2D *shader, 
        float scale) {
...
void inline set_shader_mat4_model__position(
        GL_Shader_2D *shader,
...
void inline set_shader_mat4_view__scale(
        GL_Shader_2D *shader, 
        float scale) {
...
void inline set_shader_mat4_view__position(
        GL_Shader_2D *shader,
        float x, 
        float y, 
        float z) {
