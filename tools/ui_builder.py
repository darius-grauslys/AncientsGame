...
def generate_source__ui(xml_node__ui):
    ...
    generate_source_h__with_literal(\
            ...
            config.source_name))
    generate_source_h__arguments(["Gfx_Context *p_gfx_context, Graphics_Window *p_gfx_window, World *p_world, UI_Manager *p_ui_manager"])
    generate_source_h__with_literal(";\n")
    ...
    generate_source_c__with_literal(\
            "\nbool allocate_ui_for__{}".format(\
            config.source_name))
    generate_source_c__arguments(["Gfx_Context *p_gfx_context, Graphics_Window *p_gfx_window, World *p_world, UI_Manager *p_ui_manager"])
    generate_source_c__with_literal("{\n")
