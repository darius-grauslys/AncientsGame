...
UI_Element *NDS_allocate_ui_for__nds_ui_window__menu__singleplayer(Game *p_game){
    ...
    set_ui_button_as__toggleable_or__non_toggleable(p_button__play, false);
    set_ui_button_as__toggled_or__not_toggled(p_button__play, false);
    set_ui_element__hitbox(p_button__play, 104, 96, get_vector__3i32(184 + 0, 116 + 0, 0));
