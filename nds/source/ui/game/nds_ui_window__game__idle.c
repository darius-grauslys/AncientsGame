...
NDS_allocate_ui_for__nds_ui_window__game__hud(p_game);
    ...
    for (Index__u32 index_of__itteration__1=0;p_ui_itterator;iterate_to_next__ui_element(&p_ui_itterator),index_of__itteration__1++) {
        p_ui_itterator_previous = p_ui_itterator;
        initialize_ui_element_as__button(p_ui_itterator, 16, 12, get_vector__3i32(28 + 0* index_of__itteration__1, 96 + 24* index_of__itteration__1, 0), m_ui_button__clicked_handler__default, false, false);
    }
}
