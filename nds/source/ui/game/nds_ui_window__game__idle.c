...
UI_Element *NDS_allocate_ui_for__nds_ui_window__game__idle(Game *p_game){
    ...
    set_ui_element__hitbox(p_slider, 16, 80, get_vector__3i32(220 + 0, 92 + 0, 0));
    ...
    set_ui_element__hitbox(p_button__chat, 32, 16, get_vector__3i32(204 + 0, 178 + 0, 0));
    ...
    for (Index__u32 index_of__itteration__1=0;p_ui_itterator;itterate_to_next__ui_element(&p_ui_itterator) && (++index_of__itteration__1)) {
        ...
        set_ui_element__hitbox(p_ui_itterator, 16, 12, get_vector__3i32(20 + 0* index_of__itteration__1, 90 + 24* index_of__itteration__1, 0));
    }
}
