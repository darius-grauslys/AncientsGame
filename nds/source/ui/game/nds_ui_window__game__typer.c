...
UI_Element *NDS_allocate_ui_for__nds_ui_window__game__typer(Game *p_game){
    ...
    set_ui_element__hitbox(p_hide, 32, 16, get_vector__3i32(196 + 0, 64 + 0, 0));
    ...
    for (Index__u32 index_of__itteration__2=0;p_ui_itterator;itterate_to_next__ui_element(&p_ui_itterator) && (++index_of__itteration__2)) {
        ...
        set_ui_element__hitbox(p_ui_itterator, 14, 12, get_vector__3i32(27 + 15* index_of__itteration__2, 112 + 0* index_of__itteration__2, 0));
    }
    ...
    for (Index__u32 index_of__itteration__3=0;p_ui_itterator;itterate_to_next__ui_element(&p_ui_itterator) && (++index_of__itteration__3)) {
        set_ui_element__clicked_handler(p_ui_itterator, m_ui_button__clicked_handler__default);
        set_ui_element__hitbox(p_ui_itterator, 14, 12, get_vector__3i32(33 + 15* index_of__itteration__3, 125 + 0* index_of__itteration__3, 0));
    }
    ...
    set_ui_element__hitbox(p_backspace, 29, 12, get_vector__3i32(183 + 0, 125 + 0, 0));
    ...
    set_ui_element__hitbox(p_shift, 18, 12, get_vector__3i32(20 + 0, 138 + 0, 0));

    p_ui_itterator = allocate_many_ui_elements_from__ui_manager_in__succession(p_ui_manager, 9);
    for (Index__u32 index_of__itteration__3=0;p_ui_itterator;itterate_to_next__ui_element(&p_ui_itterator) && (++index_of__itteration__3)) {
        set_ui_element__clicked_handler(p_ui_itterator, m_ui_button__clicked_handler__default);
        set_ui_element__hitbox(p_ui_itterator, 14, 12, get_vector__3i32(39 + 15* index_of__itteration__3, 138 + 0* index_of__itteration__3, 0));
    }
    ...
    set_ui_element__hitbox(p_send, 29, 12, get_vector__3i32(174 + 0, 138 + 0, 0));
    ...
    set_ui_element__hitbox(p_sym, 23, 12, get_vector__3i32(20 + 0, 151 + 0, 0));

    p_ui_itterator = allocate_many_ui_elements_from__ui_manager_in__succession(p_ui_manager, 10);
    for (Index__u32 index_of__itteration__3=0;p_ui_itterator;itterate_to_next__ui_element(&p_ui_itterator) && (++index_of__itteration__3)) {
        set_ui_element__clicked_handler(p_ui_itterator, m_ui_button__clicked_handler__default);
        set_ui_element__hitbox(p_ui_itterator, 14, 12, get_vector__3i32(44 + 15* index_of__itteration__3, 151 + 0* index_of__itteration__3, 0));
    }
    ...
    for (Index__u32 index_of__itteration__3=0;p_ui_itterator;itterate_to_next__ui_element(&p_ui_itterator) && (++index_of__itteration__3)) {
        set_ui_element__clicked_handler(p_ui_itterator, m_ui_button__clicked_handler__default);
        set_ui_element__hitbox(p_ui_itterator, 14, 12, get_vector__3i32(54 + 15* index_of__itteration__3, 164 + 0* index_of__itteration__3, 0));
    }
    ...
    set_ui_element__hitbox(p_space, 59, 12, get_vector__3i32(84 + 0, 164 + 0, 0));

    p_ui_itterator = allocate_many_ui_elements_from__ui_manager_in__succession(p_ui_manager, 2);
    for (Index__u32 index_of__itteration__3=0;p_ui_itterator;itterate_to_next__ui_element(&p_ui_itterator) && (++index_of__itteration__3)) {
        set_ui_element__clicked_handler(p_ui_itterator, m_ui_button__clicked_handler__default);
        set_ui_element__hitbox(p_ui_itterator, 14, 12, get_vector__3i32(144 + 15* index_of__itteration__3, 164 + 0* index_of__itteration__3, 0));
    }
