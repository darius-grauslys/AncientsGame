...
static bool inline is_ui_flags__allocated(UI_Flags__u16 ui_flags__u8) {
    return (bool)(ui_flags__u8 & UI_FLAGS__BIT_IS_ALLOCATED);
}

static bool inline is_ui_flags__enabled(UI_Flags__u16 ui_flags__u8) {
    return (bool)(ui_flags__u8 & UI_FLAGS__BIT_IS_ENABLED);
}

static bool inline is_ui_flags__needing_update(UI_Flags__u16 ui_flags__u8) {
    return (bool)(ui_flags__u8 & UI_FLAGS__BIT_IS_NEEDING_UPDATE);
}

static bool inline is_ui_flags__being_held(UI_Flags__u16 ui_flags__u8) {
    return (bool)(ui_flags__u8 & UI_FLAGS__BIT_IS_BEING_HELD);
}

static bool inline is_ui_flags__being_dragged(UI_Flags__u16 ui_flags__u8) {
    return (bool)(ui_flags__u8 & UI_FLAGS__BIT_IS_BEING_DRAGGED);
}

static bool inline is_ui_flags__focused(
        UI_Flags__u16 ui_flags__u8) {
